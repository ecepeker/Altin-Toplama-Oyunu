...
public class ayarlar {
	...
	public ayarlar() {
		...
		System.out.println(oyun.toplamAltinSayisi);
		...
		altinYuzdesiTextField.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				float altinYuzdesiTut=Float.parseFloat(str);
				//oyun.gorunurAltinYuzdesi=altinYuzdesiTut;
				//System.out.println(oyun.gorunurAltinYuzdesi);
