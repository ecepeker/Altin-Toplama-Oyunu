...
public class oyuncu {
	private String name;
	int baslangicAltin,hedefBedeli,hamleBedeli;
	int toplamAdim,harcananAltin,toplananAltin,kasadakiAltin; 
	//kasadakiAltin=baslangicAltin-harcananAltin+toplananAltin;
